...
java -jar pdfsigner.jar -i document_fields.pdf -o signed_fieldmdp_all.pdf -pkcs demo-rsa2048.p12 -password demo-rsa2048 -sigtype approval -transform fieldmdp -fieldmpd_action action -sigview visible -sigimg PdfInsecurityTeam-Logo.png

# FieldMDP Protecting including fields: Action=Include, Fields=Text1,Text2
java -jar pdfsigner.jar -i document_fields.pdf -o signed_fieldmdp_included.pdf -pkcs demo-rsa2048.p12 -password demo-rsa2048 -sigtype approval -transform fieldmdp -fieldmpd_action include -fieldmpd_fields Text1,Text2 -sigview visible -sigimg PdfInsecurityTeam-Logo.png

# FieldMDP Protecting including fields: Action=Exclude, Fields=Text1
java -jar pdfsigner.jar -i document_fields.pdf -o signed_fieldmdp_excluded.pdf -pkcs demo-rsa2048.p12 -password demo-rsa2048 -sigtype approval -transform fieldmdp -fieldmpd_action include -fieldmpd_fields Text1 -sigview visible -sigimg PdfInsecurityTeam-Logo.png

# FieldMDP Protecting including fields: Action=All, Lock=empty
java -jar pdfsigner.jar -i document_fields.pdf -o signed_fieldmdp_all_empty_locked.pdf -pkcs demo-rsa2048.p12 -password demo-rsa2048 -sigtype approval -transform fieldmdp -fieldmpd_action all -sigview visible -lock true -lockfields "" -sigimg PdfInsecurityTeam-Logo.png
