...
//        }
        ...
        transformParams.setItem(COSName.V, COSName.getPDFName("2.2"));
        ...
        sigRef.setItem(COSName.getPDFName("TransformMethod"), COSName.getPDFName("UR3"));
...
//        signature.getCOSObject().setItem(COS_NAME_ALL, lock);
        ...
        permsDict.setItem(COSName.getPDFName("UR3"), signature);
